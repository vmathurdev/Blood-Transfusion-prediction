...
st.markdown("<h1 style='text-align: center; color: #C0C0C0;'><strong><u>Blood Transfusion Prediction</u></strong></h1>", unsafe_allow_html=True)

image = Image.open('blood.jpg')
st.image(image,width=700)

st.sidebar.markdown("<h1 style='text-align: center; color:#C0C0C0 ;'><strong><u> Input Parameters (User Input)</u></strong></h1>", unsafe_allow_html=True)
